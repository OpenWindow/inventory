...
namespace Inventory.Data
{
    public static class DbInitializer
    {
        public static void Initialize(InventoryContext context)
        {
            ...
            var categories = new InventoryCategory[]
            {
                new InventoryCategory { Name ="Kitchen", Description="all inventory in kitchen" },
                new InventoryCategory { Name ="Living Room", Description="all inventory in living room" },
                new InventoryCategory { Name ="Bed Rooms", Description="all inventory in all bed rooms" }
            };
            foreach (InventoryCategory c in categories)
            {
